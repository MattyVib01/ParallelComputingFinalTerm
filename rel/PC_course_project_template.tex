...
Come prima esperimento valutiamo le tre versioni in termini di tempo di esecuzione e speedup nel caso in cui nelle versioni parallele si vadano a creare chunk tutti della stessa dimensione, ossia del numero di caratteri/parole totali diviso il numero di core. Ed usiamo un numero di core pari a 4 in entrambe le versioni.

%table (Testo x Modalità X Caratteri/Parole X execTime/speedup con fissi 4 core)
